...
class GenericStateCollectorTest {
    ...
    @BeforeAll
    static void setUp() {
        stateCollector = new GenericStateCollector<>(new ParentFirstFlowchartMouse(), State.class);
        textCollector = new GenericStateCollector<>(new ParentFirstFlowchartMouse(), Text.class);
    }
