...
import com.dododo.ariadne.mxg.common.factory.SwitchBlockComparatorFactory;
...
public final class SwitchBlock extends Block {
    ...
    @Override
    public void accept(BlockFlowchartMouseStrategy strategy, BlockFlowchartContract callback, Collection<Block> grayBlocks, Collection<Block> blackBlocks) {
        strategy.acceptSwitchBlock(this, callback, grayBlocks, blackBlocks);
    }
