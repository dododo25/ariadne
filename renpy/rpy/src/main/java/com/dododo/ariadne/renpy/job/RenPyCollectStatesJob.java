...
import com.dododo.ariadne.renpy.processor.RenPyLineProcessorFactory;
...
public final class RenPyCollectStatesJob extends AbstractJob {
    ...
    public RenPyCollectStatesJob(int index) {
        super(String.format("%s_%d", RenPyCollectStatesJob.class.getSimpleName(), index));
        this.index = index;
    }

    @Override
    public void run() {
        processor = RenPyLineProcessorFactory.create(getConfiguration());
