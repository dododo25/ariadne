...
class ChildFirstRenPyLargeTreeFlowchartMouseStrategyTest {
    ...
    void testAcceptTreeShouldDoneWell() {
        ...
        List<State> expected = Arrays.asList(s2, s1, s4, s3);
    ...
    private void testAcceptTreeShouldDoneWell(Collection<State> expected, State rootState) {
        ...
        LargeTreeFlowchartMouseStrategy strategy = new ChildFirstRenPyLargeTreeFlowchartMouseStrategy(states, 2);
